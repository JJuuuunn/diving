  ...
  <div class="medical-finder-container">
    ...
    <header class="medical-header">
      ...
      <div class="fade-in-up delay header-actions-wrapper">
        <!-- 의사 설득용 가이드라인 버튼 -->
        <CustomButton class="guide-btn" @click="showGuideModal = true">
          🩺 의사 선생님 설득용 가이드라인 보기
        </CustomButton>

        <!-- 🏥 신규 병원 제보하기 버튼 (방안 B) -->
        <CustomButton class="suggest-btn" @click="openSuggestModal">
          🏥 내가 아는 발급 성공 병원 제보하기
        </CustomButton>
    ...
    <div class="hospital-list" v-else-if="filteredHospitals.length > 0">
      ...
      >
        ...
        <div class="review-section">
          <CustomButton class="review-toggle-btn" @click.stop="toggleReviews(hospital.id)">
    ...
    <div v-if="showGuideModal" class="guide-modal-overlay" @click.self="showGuideModal = false">
      <div class="guide-modal-content">
        <div class="modal-header">
          ...
          <CustomButton class="close-modal-btn" @click="showGuideModal = false">×</CustomButton>
        </div>
          ...
          <section class="modal-section alert-box">
            ...
            <ul>
              <li>
                ...
                <div class="modal-online-links">
                  <a href="https://www.uhms.org/images/Diver-Medical-Participant-Questionnaire.pdf" target="_blank" rel="noopener noreferrer">UHMS 공식 사이트 🌐</a>
                  <span>|</span>
                  <a href="https://drive.google.com/drive/folders/1DzpHdxEqGUHwxU7E7cHgVkfvKgRa1wQx" target="_blank" rel="noopener noreferrer">AIDA 구글 드라이브 📂</a>
                </div>
              </li>
              <li>신분증</li>
        ...
        <div class="modal-footer">
          <CustomButton class="confirm-btn" @click="showGuideModal = false">확인했습니다</CustomButton>
        </div>
      </div>
    </div>
    ...
    <div v-if="showSuggestModal" class="suggest-modal-overlay" @click.self="closeSuggestModal">
      <div class="suggest-modal-content scale-in">
        <div class="modal-header">
          <h2>🏥 발급 성공 병원 제보하기</h2>
          <CustomButton class="close-modal-btn" @click="closeSuggestModal">×</CustomButton>
        </div>
    ...
    <div v-if="showFormsModal" class="forms-modal-overlay" @click.self="showFormsModal = false">
      <div class="forms-modal-content scale-in">
        <div class="modal-header">
          ...
          <CustomButton class="close-modal-btn" @click="showFormsModal = false">×</CustomButton>
        </div>
        <div class="modal-body">
          <p class="modal-intro">
        ...
        <div class="modal-footer">
          <CustomButton class="confirm-btn" @click="showFormsModal = false">확인했습니다</CustomButton>
        </div>
      </div>
    </div>
