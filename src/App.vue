...
// --- State ---
const poolPrices = {
  'deepstation': { weekday: 44000, weekend: 66000 },
  'k26': { weekday: 33000, weekend: 55000 },
  'paradive': { weekday: 40000, weekend: 50000 },
  'custom': null
};
...
const people = ref([
  { id: 1, name: '예약자 1', isBooker: true, isMember: true, prepaid: 0, bank: '', account: '' },
  { id: 2, name: '참석자 2', isBooker: false, isMember: false, prepaid: 0, bank: '', account: '' },
  { id: 3, name: '참석자 3', isBooker: false, isMember: false, prepaid: 0, bank: '', account: '' }
]);
...
const addPerson = () => {
  people.value.push({ id: Date.now(), name: `참석자 ${people.value.length + 1}`, isBooker: false, isMember: true, prepaid: 0, bank: '', account: '' });
};
...
const shareUrlOnly = () => copyText(getCurrentShareUrl(), "링크가 복사되었습니다! 🔗");
...
<template>
  <div class="top-right-controls">
    <button @click="toggleDarkMode" class="control-btn dark-mode-btn">
      <i class="fa-solid fa-moon"></i>
      <i class="fa-solid fa-sun"></i>
    </button>
     <button @click="shareUrlOnly" class="control-btn share-btn">
      <i class="fa-solid fa-link"></i>
      <span class="share-btn-icon">링크 복사</span>
    </button>
  </div>
  ...
  <div class="container">
    ...
    <main class="main-content">
      ...
      <footer class="footer">Designed for Divers 🤿</footer>
    </main>
  </div>
